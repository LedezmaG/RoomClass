...
export const StudenSettingsModal = ({isNew, isEdit}) => {
    ...
    return (
        <div 
            ...
            tabindex="-1" 
            aria-labelledby="settingsStudenLabel" 
            aria-hidden="true"
        >
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="settingsStudenLabel">
                            { isNew && "Agregar alumno" }
                            { isEdit && "Alumno" }
                        </h1>
